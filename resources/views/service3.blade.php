...
@section('content')
<img src="{{ asset('img/service3_bar.png') }}" class="service_bar">


<div class="service_list_div">
    <div class="service_item_div">
        <img src="{{ asset('img/service3.png') }}" class="service_main_img">
        <div class="service1_text_box">
            <div class="service_title_orange_en">CONSULTING</div>
            <div class="service_title_orange_ja">集客・広報コンサルティングについて</div>
        ...
        <div class="service_center_title">
            ...
            <div class="service_title_orange_ja">集客・広報コンサルティングのサービスについて</div>
        </div>
...
<img src="{{ asset('img/service3_bar_sp.png') }}" class="service_bar">
