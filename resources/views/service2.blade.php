...
<div class="service_list_div">
    <div class="service_item_div">
        ...
        <div class="service1_text_box">
            ...
            <div class="service_title_orange_ja">納骨堂コンサルティングについて</div>
        ...
        <div class="service_center_title">
            ...
            <div class="service_title_orange_ja">納骨堂コンサルティングのサービスについて</div>
        </div>
...
<img src="{{ asset('img/service2_bar_sp.png') }}" class="service_bar">
